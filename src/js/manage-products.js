  ...
  editFormContainer.innerHTML = `
      <div class="form-container">
          ...
          <form id="edit-form">
              ...
              <input type="number" id="old-price" name="old-price" value="${
                productToEdit.oldPrice
              }">

              <label for="new-price">Giá mới:</label>
              <input type="number" id="new-price" name="new-price" value="${
                productToEdit.newPrice
              }">

             <label for="book-type">Loại sách:</label>
              <select id="book-type" name="book-type">
                  <option value="" disabled ${
                    !productToEdit.bookType ? "selected" : ""
                  }>Chọn Loại Sách</option>
                  <option value="Văn Học" ${
                    productToEdit.bookType === "Văn Học" ? "selected" : ""
                  }>Văn Học</option>
                  <option value="Kinh Tế" ${
                    productToEdit.bookType === "Kinh Tế" ? "selected" : ""
                  }>Kinh Tế</option>
                  <option value="Sách giáo khoa" ${
                    productToEdit.bookType === "Sách giáo khoa"
                      ? "selected"
                      : ""
                  }>Sách giáo khoa</option>
                  <option value="Tâm Lý - Kỹ Năng Sống" ${
                    productToEdit.bookType === "Tâm Lý - Kỹ Năng Sống"
                      ? "selected"
                      : ""
                  }>Tâm Lý - Kỹ Năng Sống</option>
                  <option value="Truyện Tranh" ${
                    productToEdit.bookType === "Truyện Tranh" ? "selected" : ""
                  }>Truyện Tranh</option>
              </select>
              ...
              <select id="category" name="category">
                  ...
                  <option value="Tiểu thuyết" ${
                    productToEdit.category === "Tiểu thuyết" ? "selected" : ""
                  }>Tiểu thuyết</option>
                  <option value="Truyện ngắn" ${
                    productToEdit.category === "Truyện ngắn" ? "selected" : ""
                  }>Truyện ngắn</option>
                  <option value="Ngôn tình" ${
                    productToEdit.category === "Ngôn tình" ? "selected" : ""
                  }>Ngôn tình</option>
                  <option value="Bài học kinh doanh" ${
                    productToEdit.category === "Bài học kinh doanh"
                      ? "selected"
                      : ""
                  }>Bài học kinh doanh</option>
                  <option value="Quản trị - Lãnh đạo" ${
                    productToEdit.category === "Quản trị - Lãnh đạo"
                      ? "selected"
                      : ""
                  }>Quản trị - Lãnh đạo</option>
                  <option value="Marketing" ${
                    productToEdit.category === "Marketing" ? "selected" : ""
                  }>Marketing</option>
                  <option value="Phân tích kinh tế" ${
                    productToEdit.category === "Phân tích kinh tế"
                      ? "selected"
                      : ""
                  }>Phân tích kinh tế</option>
                  <option value="Sách giáo khoa" ${
                    productToEdit.category === "Sách giáo khoa"
                      ? "selected"
                      : ""
                  }>Sách giáo khoa</option>
                  <option value="Sách luyện thi THPTQG" ${
                    productToEdit.category === "Sách luyện thi THPTQG"
                      ? "selected"
                      : ""
                  }>Sách luyện thi THPTQG</option>
                  <option value="Sách mẫu giáo" ${
                    productToEdit.category === "Sách mẫu giáo" ? "selected" : ""
                  }>Sách mẫu giáo</option>
                  <option value="Kỹ năng sống" ${
                    productToEdit.category === "Kỹ năng sống" ? "selected" : ""
                  }>Kỹ năng sống</option>
                  <option value="Rèn luyện nhân cách" ${
                    productToEdit.category === "Rèn luyện nhân cách"
                      ? "selected"
                      : ""
                  }>Rèn luyện nhân cách</option>
                  <option value="Tâm lý" ${
                    productToEdit.category === "Tâm lý" ? "selected" : ""
                  }>Tâm lý</option>
                  <option value="Sách cho tuổi mới lớn" ${
                    productToEdit.category === "Sách cho tuổi mới lớn"
                      ? "selected"
                      : ""
                  }>Sách cho tuổi mới lớn</option>
                  <option value="Manga (Nhật Bản)" ${
                    productToEdit.category === "Manga (Nhật Bản)"
                      ? "selected"
                      : ""
                  }>Manga (Nhật Bản)</option>
                  <option value="Manhwa (Hàn Quốc)" ${
                    productToEdit.category === "Manhwa (Hàn Quốc)"
                      ? "selected"
                      : ""
                  }>Manhwa (Hàn Quốc)</option>
                  <option value="Manhua (Trung Quốc)" ${
                    productToEdit.category === "Manhua (Trung Quốc)"
                      ? "selected"
                      : ""
                  }>Manhua (Trung Quốc)</option>
                  <option value="Comic (Phương Tây)" ${
                    productToEdit.category === "Comic (Phương Tây)"
                      ? "selected"
                      : ""
                  }>Comic (Phương Tây)</option>
                  <option value="Truyện tranh thiếu nhi" ${
                    productToEdit.category === "Truyện tranh thiếu nhi"
                      ? "selected"
                      : ""
                  }>Truyện tranh thiếu nhi</option>
              </select>
              ...
              <input type="text" id="publisher" name="publisher" value="${
                productToEdit.publisher
              }">

              <label for="author">Tác giả:</label>
              <input type="text" id="author" name="author" value="${
                productToEdit.author
              }">

              <label for="form">Hình thức:</label>
              <input type="text" id="form" name="form" value="${
                productToEdit.form
              }">

              <label for="description">Mô tả sản phẩm:</label>
              <textarea id="description" name="description" oninput="adjustHeight(this)">${
              ...
              <img id="image-preview" src="${
                productToEdit.image
              }" style="display: block; max-width: 200px; margin: 10px 0;">
